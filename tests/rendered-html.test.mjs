...
test("keeps the production shell, SEO, and accessibility safeguards in source", async () => {
  ...
  assert.match(gateway, /ptal-copper-dispenser-lifestyle\.jpg/);
  ...
  assert.doesNotMatch(gateway, /ptal-(?:copper-tumbler|brass-davara|brass-ladles|kansa-thaali)/);
  assert.doesNotMatch(loading, /ptal-(?:copper-tumbler|brass-davara|brass-ladles|kansa-thaali)/);
  ...
  await access(new URL("../public/images/curated/ptal-copper-bottle.jpg", import.meta.url));
  await access(new URL("../public/images/curated/ptal-copper-dispenser-lifestyle.jpg", import.meta.url));
  await access(new URL("../public/images/curated/brass-davara-clean.jpg", import.meta.url));
  await access(new URL("../public/images/curated/ptal-brass-masala-box.jpg", import.meta.url));
  await access(new URL("../public/images/curated/ptal-brass-paraat.jpg", import.meta.url));
  await access(new URL("../public/images/curated/brass-ladles-clean.png", import.meta.url));
  await access(new URL("../public/images/curated/ptal-brass-roti-box.jpg", import.meta.url));
  await access(new URL("../public/images/curated/ptal-brass-cutlery.jpg", import.meta.url));
  await access(new URL("../public/images/curated/kansa-thaali-clean.jpg", import.meta.url));
  await access(new URL("../public/images/ptal-categories/cookware.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/kitchen-utensils.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/kitchen-accessories.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/drinkware.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/tableware.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/dinnerware.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/sets.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/copper-water.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/brass.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/kansa.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/home-decor.webp", import.meta.url));
  await access(new URL("../public/images/ptal-categories/pooja.webp", import.meta.url));
